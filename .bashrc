# This file is sourced by interactive non-login shells. It should contain commands
...
# Professional Projects are loaded from ~/.bashrc.d/work.bashrc

# Load local configurations
if [ -d ~/.bashrc.d ]; then
	for profile in ~/.bashrc.d/*.bashrc; do
