...
alias df='df -h'
alias du='du -h'
alias movsync='rsync --archive --compress --delete --exclude=.porn --exclude=Gay --exclude=.DS_Store --progress rsync://media-center.home.robgant.com/rgant/Movies/ ~/Movies/'
